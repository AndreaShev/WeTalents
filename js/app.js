(() => {
    ...
    let closeButton = document.querySelector(".cookie__close");
    let acceptButtons = document.querySelectorAll(".cookie__buttons .cookie__button");
    let cookieBanner = document.querySelector(".cookie__banner");
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        ...
        indicator.addEventListener("click", validateEmail);
        emailInput.addEventListener("keydown", (function(event) {
            const key = event.key;
            if (key === "Enter") validateEmail();
        }));
        function validateEmail() {
            ...
            let emailInputContainer = document.querySelector(".email-we-talented__input");
            if (isValidEmail) {
